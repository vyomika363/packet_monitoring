...
# Environment
This project runs inside a virtualized Linux environment (tested on Ubuntu via VirtualBox). Download and install Oracle VirtualBox or VMware. Download the Ubuntu Desktop or Server ISO. Create a new VM, allocate RAM and disk space, mount the ISO and complete the OS installation. Install VS Code inside the VM.
